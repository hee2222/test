...
const replaceFragmentShader1 = (fragmentShader) =>
  fragmentShader
    .replace(
      `#include <common>`,
      `#include <common>
...
export const fullOpacityOnApproach = (shader) => {
  shader.fragmentShader = replaceFragmentShader1(shader.fragmentShader);
};
