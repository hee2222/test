...
export function Suni(props) {
  ...
  useEffect(() => {
    if (actions?.['cape']?.play() !== undefined) {
      actions?.['cape'].play();
    }
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <mesh
          name="cape-loop"
          geometry={nodes['cape-loop'].geometry}
          material={materials['yellow.002']}
          morphTargetDictionary={nodes['cape-loop'].morphTargetDictionary}
          morphTargetInfluences={nodes['cape-loop'].morphTargetInfluences}
        />
      </group>
    </group>
  );
